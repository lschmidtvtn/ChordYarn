 ...
 * This file demonstrates how to integrate Chordyarn with a web frontend
 */

// For React/Vue/Angular applications
export class ChordyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChordyarnClient(provider, contractAddress);
